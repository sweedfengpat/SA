...
func TelEQ(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTel), v))
	})
}
...
func TelNEQ(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func TelIn(vs ...int) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TelNotIn(vs ...int) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TelGT(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func TelGTE(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func TelLT(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func TelLTE(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasConfirmation() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ConfirmationTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ConfirmationTable, ConfirmationColumn),
		)
...
func HasConfirmationWith(preds ...predicate.Confirmation) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBillWith(preds ...predicate.Bill) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
